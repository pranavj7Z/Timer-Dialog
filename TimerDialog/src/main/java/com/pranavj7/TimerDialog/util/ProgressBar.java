package com.pranavj7.TimerDialog.util;

/**
 * Created by kuttanz on 16/4/18.
 */
        ...
        import com.pranavj7.TimerDialog.R;
...
public class ProgressBar extends View {
    ...
    public ProgressBar(@NonNull final Context context) {
        super(context);
        initialize(context, null, 0, 0);
    }

    public ProgressBar(@NonNull final Context context, @Nullable final AttributeSet attrs) {
        super(context, attrs);
